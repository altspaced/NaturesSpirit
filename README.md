...
[![Minecraft](https://img.shields.io/badge/Minecraft-26.2-brightgreen?style=for-the-badge&logo=minecraft&logoColor=white)](https://www.minecraft.net/)
...
[![NeoForge](https://img.shields.io/badge/NeoForge-26.2.0.19--beta-c33c36?style=for-the-badge)](https://neoforged.net/)
...
> It is a **26.2-focused port / maintenance branch** built so Nature's Spirit can run on the new Minecraft generation while staying faithful to upstream design.
...
This repository packages that experience for **Minecraft 26.2** as a **multiloader** project:

| Loader | Status | Artifact |
|--------|--------|----------|
| **Fabric** | Supported | `natures_spirit-fabric-2.3.0+26.2.jar` |
| **NeoForge** | Supported | `natures_spirit-neoforge-2.3.0+26.2.jar` |
...
| Fabric API | `0.145.1+26.2` (or matching `+26.2` build) |
| NeoForge | `26.2.0.19-beta` (pinned for MC 26.2) |
