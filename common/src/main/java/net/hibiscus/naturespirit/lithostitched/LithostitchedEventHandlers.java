...
public final class LithostitchedEventHandlers {
    private static final ResourceKey<Region> TERRA_FERAX = ResourceKey.create(LithostitchedRegistries.REGION, Identifier.fromNamespaceAndPath(NaturesSpirit.MOD_ID, "terra_ferax"));
    private static final ResourceKey<Region> TERRA_FLAVA = ResourceKey.create(LithostitchedRegistries.REGION, Identifier.fromNamespaceAndPath(NaturesSpirit.MOD_ID, "terra_flava"));
    private static final ResourceKey<Region> TERRA_LAETA = ResourceKey.create(LithostitchedRegistries.REGION, Identifier.fromNamespaceAndPath(NaturesSpirit.MOD_ID, "terra_laeta"));
    private static final ResourceKey<Region> TERRA_MATER = ResourceKey.create(LithostitchedRegistries.REGION, Identifier.fromNamespaceAndPath(NaturesSpirit.MOD_ID, "terra_mater"));
    private static final ResourceKey<Region> TERRA_SOLARIS = ResourceKey.create(LithostitchedRegistries.REGION, Identifier.fromNamespaceAndPath(NaturesSpirit.MOD_ID, "terra_solaris"));
    ...
    private static void addBiomeInjector(RegistryAccess registries, BiConsumer<Identifier, BiomeInjector> consumer, String name,
        ...
        consumer.accept(
                Identifier.fromNamespaceAndPath(NaturesSpirit.MOD_ID, name),
